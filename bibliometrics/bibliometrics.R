...
net = networkPlot(NetMatrix, n = 10, Title = " ",
                  type = "auto", size = TRUE, remove.multiple = FALSE, labelsize =1)
title("Country Collaboration", line=-1)
...
ggplot(bib,aes(PY))+
  ...
  labs(title="Number of publications of Right & Bowhead family over years",
...
ggplot(bib,aes(PY))+
  geom_bar(fill="#56B4E9")+ 
  labs(title="Number of publications of Pygmy right over years",
       x="year",y="Number of publications")+
  theme_minimal()+
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(bib,aes(PY))+
  geom_bar(fill="#56B4E9")+ 
  labs(title="Number of publications of Gray over years",
       x="year",y="Number of publications")+
  theme_minimal()+
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(bib,aes(PY))+
  geom_bar(fill="#56B4E9")+ 
  labs(title="Number of publications of Rorqual over years",
       x="year",y="Number of publications")+
  theme_minimal()+
  theme(plot.title = element_text(hjust = 0.5))
